...
public class GuitarraElectrica extends javax.swing.JInternalFrame 
 {public GuitarraElectrica() 
     {super("Guitarra Electrica Gibson ES335");
      initComponents();
 ...
 @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        lblGuitarraE.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ar/com/casamusica/proyectofinal/picture/instrumentos/GuitarraECompl.jpg"))); // NOI18N
        lblGuitarraE.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        getContentPane().add(lblGuitarraE, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 10, 340, 120));
