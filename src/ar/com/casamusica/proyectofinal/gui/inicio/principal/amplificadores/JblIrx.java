...
public class JblIrx extends javax.swing.JInternalFrame 
 {public JblIrx() 
     {super("JBL Profecional IRX180 ");
      initComponents();
 ...
 @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        lblJbl.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ar/com/casamusica/proyectofinal/picture/amplificadores/JBL IRX 108BT(1).jpg"))); // NOI18N
        ...
        lstDetalle.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "PESO: 17,4 Libras   ", "-------------------------------   ", "DIMENCIONES : 10,15''x12,32''", "                             x19,1''", "------------------------------- ", "COLOR :  NEGRO", "-------------------------------", "ACABADO: POLIPROPILENO", "                     CON REJILLA", "-------------------------------", "FRECUENCIA:  54Hz - 20Hz", "---------------------------------", "BLUETOOTH: SI", " " };
        ...
        getContentPane().add(srllDescripcion, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 10, 210, 210));
